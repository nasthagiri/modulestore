...
from modulestore.xml_importer import _update_and_import_module, _update_module_location
...
class ModuleStoreNoSettings(unittest.TestCase):
    ...
    FS_ROOT = DATA_DIR
    DEFAULT_CLASS = 'modulestore.tests.test_xml_importer.StubXBlock'
    ...
    MODULESTORE = {
        'ENGINE': 'modulestore.mongo.DraftMongoModuleStore',
