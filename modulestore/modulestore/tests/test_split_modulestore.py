...
from modulestore.split_mongo.split import SplitMongoModuleStore
from modulestore.tests.test_modulestore import check_has_course_method
from modulestore.split_mongo import BlockKey
from modulestore.tests.factories import check_mongo_calls
from modulestore.tests.mongo_connection import MONGO_PORT_NUM, MONGO_HOST
from modulestore.tests.utils import mock_tab_from_json
...
class SplitModuleTest(unittest.TestCase):
    ...
    MODULESTORE = {
        'ENGINE': 'modulestore.split_mongo.split.SplitMongoModuleStore',
...
class TestCourseStructureCache(SplitModuleTest):
    ...
    @patch('modulestore.split_mongo.mongo_connection.get_cache')
