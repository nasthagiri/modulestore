...
from modulestore.modulestore_settings import (
...
class ModuleStoreSettingsMigration(TestCase):
    ...
    OLD_CONFIG = {
        "default": {
            "ENGINE": "modulestore.xml.XMLModuleStore",
            "OPTIONS": {
                "data_dir": "directory",
    ...
    OLD_CONFIG_WITH_DIRECT_MONGO = {
        "default": {
            "ENGINE": "modulestore.mongo.MongoModuleStore",
            "OPTIONS": {
    ...
    def assertMigrated(self, old_setting):
        ...
        self.assertEqual(new_mixed_setting["default"]["ENGINE"], "modulestore.mixed.MixedModuleStore")
    ...
    def test_convert_from_old_mongo_to_draft_store(self):
        ...
        new_mixed_setting, new_default_store_setting = self.assertMigrated(old_setting)
        self.assertStoreValuesEqual(new_default_store_setting, old_setting["default"])
        self.assertEqual(new_default_store_setting["ENGINE"], "modulestore.mongo.draft.DraftModuleStore")
