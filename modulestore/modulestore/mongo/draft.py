...
from modulestore.mongo.base import (
    MongoModuleStore, MongoRevisionKey, as_draft, as_published, SORT_REVISION_FAVOR_DRAFT
)
from modulestore.store_utilities import rewrite_nonportable_content_links
...
class DraftModuleStore(MongoModuleStore):
    ...
    def get_item(self, usage_key, depth=0, revision=None, using_descriptor_system=None, **kwargs):
        ...
        Raises:
            ...
            modulestore.exceptions.ItemNotFoundError if no object
