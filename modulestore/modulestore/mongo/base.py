...
from modulestore import ModuleStoreWriteBase, ModuleStoreEnum, BulkOperationsMixin, BulkOpsRecord
from modulestore.draft_and_published import ModuleStoreDraftAndPublished, DIRECT_ONLY_CATEGORIES
from modulestore.edit_info import EditInfoRuntimeMixin
from modulestore.exceptions import ItemNotFoundError, DuplicateCourseError, ReferentialIntegrityError
from modulestore.inheritance import InheritanceMixin, inherit_metadata, InheritanceKeyValueStore
from modulestore.xml import CourseLocationManager
...
class MongoModuleStore(ModuleStoreDraftAndPublished, ModuleStoreWriteBase, MongoBulkOpsMixin):
    ...
    def get_item(self, usage_key, depth=0, using_descriptor_system=None, for_parent=None, **kwargs):
        ...
        If any segment of the location is None except revision, raises
            modulestore.exceptions.InsufficientSpecificationError
        If no object is found at that location, raises
            modulestore.exceptions.ItemNotFoundError
