...
from modulestore.exceptions import InsufficientSpecificationError, VersionConflictError, DuplicateItemError, \
...
from modulestore.split_mongo.mongo_connection import MongoConnection, DuplicateKeyError
