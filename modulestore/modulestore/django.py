...
from contentstore.django import contentstore
from modulestore.draft_and_published import BranchSettingMixin
from modulestore.mixed import MixedModuleStore
from utils.django import get_current_request_hostname
...
class SignalHandler(object):
    ...
    To listen for a signal, do the following::
        ...
        from modulestore.django import modulestore, SignalHandler
...
def modulestore():
    ...
    if _MIXED_MODULESTORE is None:
        ...
        if settings.FEATURES.get('CUSTOM_COURSES_EDX'):
            ...
            modulestore_wrapper = load_function('lms.djangoapps.ccx.modulestore.CCXModulestoreWrapper')
            _MIXED_MODULESTORE = modulestore_wrapper(_MIXED_MODULESTORE)
