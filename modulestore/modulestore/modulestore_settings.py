...
def convert_module_store_setting_if_needed(module_store_setting):
    ...
    def convert_old_stores_into_list(old_stores):
        ...
        for store_name, store_settings in old_stores.iteritems():
            ...
            if store_settings['ENGINE'] == 'modulestore.mongo.MongoModuleStore':
                warnings.warn("MongoModuleStore is deprecated! Please use DraftModuleStore.", DeprecationWarning)
                store_settings['ENGINE'] = 'modulestore.mongo.draft.DraftModuleStore'
    ...
    if module_store_setting['default']['ENGINE'] != 'modulestore.mixed.MixedModuleStore':
    ...
    if not is_split_defined:
        ...
        if mongo_store:
            ...
            split_store['ENGINE'] = 'modulestore.split_mongo.split_draft.DraftVersioningModuleStore'
