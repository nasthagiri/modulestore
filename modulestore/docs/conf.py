...
"""
modulestore documentation build configuration file.
...
htmlhelp_basename = 'modulestoredoc'
...
latex_documents = [
    (master_doc, 'modulestore.tex', 'modulestore Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'modulestore', 'modulestore Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'modulestore', 'modulestore Documentation',
     author, 'modulestore', 'Openedx Modulestore',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'modulestore'),
                os.path.join(root_path, 'modulestore/migrations')])
